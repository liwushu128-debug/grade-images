...
Do not describe tone compression as recovered detail. Fully clipped encoded pixels contain no recoverable scene information. RAW support may later expose sensor detail that is absent from an encoded JPEG, but v0.2 does not process RAW.
